...
var (
	...
	fd_ConsensusParams_blob      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ConsensusParams_blob = md_ConsensusParams.Fields().ByName("blob")
}
...
func (x *fastReflection_ConsensusParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Blob != nil {
		value := protoreflect.ValueOfMessage(x.Blob.ProtoReflect())
		if !f(fd_ConsensusParams_blob, value) {
			return
		}
	}
}
...
func (x *fastReflection_ConsensusParams) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "tendermint.types.ConsensusParams.abci":
		return x.Abci != nil
	case "tendermint.types.ConsensusParams.blob":
		return x.Blob != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ConsensusParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "tendermint.types.ConsensusParams.blob":
		x.Blob = value.Message().Interface().(*BlobParams)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.ConsensusParams"))
		}
...
func (x *fastReflection_ConsensusParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.types.ConsensusParams.blob":
		if x.Blob == nil {
			x.Blob = new(BlobParams)
		}
		return protoreflect.ValueOfMessage(x.Blob.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.ConsensusParams"))
		}
...
func (x *fastReflection_ConsensusParams) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.Blob != nil {
			encoded, err := options.Marshal(x.Blob)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 8:
				...
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Blob); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	md_BlobParams           protoreflect.MessageDescriptor
	fd_BlobParams_max_bytes protoreflect.FieldDescriptor
)

func init() {
	file_tendermint_types_params_proto_init()
	md_BlobParams = File_tendermint_types_params_proto.Messages().ByName("BlobParams")
	fd_BlobParams_max_bytes = md_BlobParams.Fields().ByName("max_bytes")
}

var _ protoreflect.Message = (*fastReflection_BlobParams)(nil)

type fastReflection_BlobParams BlobParams

func (x *BlobParams) ProtoReflect() protoreflect.Message {
	return (*fastReflection_BlobParams)(x)
}

func (x *BlobParams) slowProtoReflect() protoreflect.Message {
	mi := &file_tendermint_types_params_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_BlobParams_messageType fastReflection_BlobParams_messageType
var _ protoreflect.MessageType = fastReflection_BlobParams_messageType{}

type fastReflection_BlobParams_messageType struct{}

func (x fastReflection_BlobParams_messageType) Zero() protoreflect.Message {
	return (*fastReflection_BlobParams)(nil)
}
func (x fastReflection_BlobParams_messageType) New() protoreflect.Message {
	return new(fastReflection_BlobParams)
}
func (x fastReflection_BlobParams_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_BlobParams
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_BlobParams) Descriptor() protoreflect.MessageDescriptor {
	return md_BlobParams
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_BlobParams) Type() protoreflect.MessageType {
	return _fastReflection_BlobParams_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_BlobParams) New() protoreflect.Message {
	return new(fastReflection_BlobParams)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_BlobParams) Interface() protoreflect.ProtoMessage {
	return (*BlobParams)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_BlobParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.MaxBytes != int64(0) {
		value := protoreflect.ValueOfInt64(x.MaxBytes)
		if !f(fd_BlobParams_max_bytes, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_BlobParams) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.types.BlobParams.max_bytes":
		return x.MaxBytes != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.BlobParams"))
		}
		panic(fmt.Errorf("message tendermint.types.BlobParams does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BlobParams) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "tendermint.types.BlobParams.max_bytes":
		x.MaxBytes = int64(0)
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_BlobParams) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "tendermint.types.BlobParams.max_bytes":
		value := x.MaxBytes
		return protoreflect.ValueOfInt64(value)
	default:
		...
		panic(fmt.Errorf("message tendermint.types.BlobParams does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BlobParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "tendermint.types.BlobParams.max_bytes":
		x.MaxBytes = value.Int()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BlobParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.BlobParams.max_bytes":
		panic(fmt.Errorf("field max_bytes of message tendermint.types.BlobParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.BlobParams"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_BlobParams) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.BlobParams.max_bytes":
		return protoreflect.ValueOfInt64(int64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_BlobParams) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.types.BlobParams", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_BlobParams) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_BlobParams) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_BlobParams) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_BlobParams) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*BlobParams)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: BlobParams: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: BlobParams: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
type ConsensusParams struct {
	...
	Blob      *BlobParams      `protobuf:"bytes,8,opt,name=blob,proto3" json:"blob,omitempty"`
}
...
func (x *ConsensusParams) GetBlob() *BlobParams {
	if x != nil {
		return x.Blob
	}
	return nil
...
type BlobParams struct {
	...
	// maximum blob size, which is 800kB (819200 bytes).
	//
	// If set to -1, the limit is the hard-coded maximum blob size.
	MaxBytes int64 `protobuf:"varint,1,opt,name=max_bytes,json=maxBytes,proto3" json:"max_bytes,omitempty"`
}

func (x *BlobParams) Reset() {
	*x = BlobParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tendermint_types_params_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *BlobParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlobParams) ProtoMessage() {}

// Deprecated: Use BlobParams.ProtoReflect.Descriptor instead.
func (*BlobParams) Descriptor() ([]byte, []int) {
	return file_tendermint_types_params_proto_rawDescGZIP(), []int{7}
}

func (x *BlobParams) GetMaxBytes() int64 {
	if x != nil {
		return x.MaxBytes
	}
	return 0
...
var file_tendermint_types_params_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe4, 0x02, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x73,
	...
	,
	...
	,
...
var file_tendermint_types_params_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_tendermint_types_params_proto_goTypes = []interface{}{
	...
	(*BlobParams)(nil),          // 7: tendermint.types.BlobParams
...
var file_tendermint_types_params_proto_depIdxs = []int32{
	...
	7, // 5: tendermint.types.ConsensusParams.blob:type_name -> tendermint.types.BlobParams
	8, // 6: tendermint.types.EvidenceParams.max_age_duration:type_name -> google.protobuf.Duration
...
func file_tendermint_types_params_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tendermint_types_params_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlobParams); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
