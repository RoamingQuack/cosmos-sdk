...
var (
	...
	fd_PublicKey_secp256k1_uncompressed protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PublicKey_secp256k1_uncompressed = md_PublicKey.Fields().ByName("secp256k1_uncompressed")
}
...
func (x *fastReflection_PublicKey) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Sum != nil {
		...
		case *PublicKey_Secp256K1Uncompressed:
			v := o.Secp256K1Uncompressed
			value := protoreflect.ValueOfBytes(v)
			if !f(fd_PublicKey_secp256k1_uncompressed, value) {
				return
			}
		}
	}
...
func (x *fastReflection_PublicKey) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "tendermint.crypto.PublicKey.secp256k1_uncompressed":
		if x.Sum == nil {
			return false
		} else if _, ok := x.Sum.(*PublicKey_Secp256K1Uncompressed); ok {
			return true
		} else {
			return false
		}
...
func (x *fastReflection_PublicKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.crypto.PublicKey.secp256k1_uncompressed":
		if x.Sum == nil {
			return protoreflect.ValueOfBytes(nil)
		} else if v, ok := x.Sum.(*PublicKey_Secp256K1Uncompressed); ok {
			return protoreflect.ValueOfBytes(v.Secp256K1Uncompressed)
		} else {
			return protoreflect.ValueOfBytes(nil)
		}
	default:
...
func (x *fastReflection_PublicKey) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "tendermint.crypto.PublicKey.secp256k1_uncompressed":
		cv := value.Bytes()
		x.Sum = &PublicKey_Secp256K1Uncompressed{Secp256K1Uncompressed: cv}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.crypto.PublicKey"))
		}
...
func (x *fastReflection_PublicKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.crypto.PublicKey.secp256k1_uncompressed":
		panic(fmt.Errorf("field secp256k1_uncompressed of message tendermint.crypto.PublicKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.crypto.PublicKey"))
		}
...
func (x *fastReflection_PublicKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	...
	case "tendermint.crypto.PublicKey.sum":
		...
		case *PublicKey_Secp256K1Uncompressed:
			return x.Descriptor().Fields().ByName("secp256k1_uncompressed")
		}
	default:
...
func (x *fastReflection_PublicKey) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		case *PublicKey_Secp256K1:
			...
			dAtA[i] = 0x12
		case *PublicKey_Secp256K1Uncompressed:
			i -= len(x.Secp256K1Uncompressed)
			copy(dAtA[i:], x.Secp256K1Uncompressed)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Secp256K1Uncompressed)))
			i--
			dAtA[i] = 0x1a
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Secp256K1Uncompressed", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				v := make([]byte, postIndex-iNdEx)
				copy(v, dAtA[iNdEx:postIndex])
				x.Sum = &PublicKey_Secp256K1Uncompressed{v}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *PublicKey) GetSecp256K1Uncompressed() []byte {
	if x, ok := x.GetSum().(*PublicKey_Secp256K1Uncompressed); ok {
...
type PublicKey_Secp256K1Uncompressed struct {
	Secp256K1Uncompressed []byte `protobuf:"bytes,3,opt,name=secp256k1_uncompressed,json=secp256k1Uncompressed,proto3,oneof"`
}
...
var file_tendermint_crypto_keys_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0xa2, 0x02, 0x03, 0x54, 0x43, 0x58, 0xaa, 0x02, 0x11, 0x54,
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f,
	0xca, 0x02, 0x11, 0x54, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x5c, 0x43, 0x72,
	0x79, 0x70, 0x74, 0x6f, 0xe2, 0x02, 0x1d, 0x54, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e,
	0x74, 0x5c, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x12, 0x54, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e,
	0x74, 0x3a, 0x3a, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
