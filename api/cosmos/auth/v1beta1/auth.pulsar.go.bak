...
var (
	...
	fd_Params_max_tx_gas                protoreflect.FieldDescriptor
	fd_Params_tx_fees                   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_tx_fees = md_Params.Fields().ByName("tx_fees")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MaxTxGas != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxTxGas)
		if !f(fd_Params_max_tx_gas, value) {
			return
		}
	}
	if x.TxFees != "" {
		value := protoreflect.ValueOfString(x.TxFees)
		if !f(fd_Params_tx_fees, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.auth.v1beta1.Params.max_tx_gas":
		return x.MaxTxGas != uint64(0)
	case "cosmos.auth.v1beta1.Params.tx_fees":
		return x.TxFees != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.auth.v1beta1.Params.max_tx_gas":
		x.MaxTxGas = value.Uint()
	case "cosmos.auth.v1beta1.Params.tx_fees":
		x.TxFees = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.auth.v1beta1.Params.max_tx_gas":
		panic(fmt.Errorf("field max_tx_gas of message cosmos.auth.v1beta1.Params is not mutable"))
	case "cosmos.auth.v1beta1.Params.tx_fees":
		panic(fmt.Errorf("field tx_fees of message cosmos.auth.v1beta1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.MaxTxGas != 0 {
			n += 1 + runtime.Sov(uint64(x.MaxTxGas))
		}
		l = len(x.TxFees)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TxFees) > 0 {
			i -= len(x.TxFees)
			copy(dAtA[i:], x.TxFees)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TxFees)))
			i--
			dAtA[i] = 0x3a
		}
		if x.MaxTxGas != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxTxGas))
			i--
			dAtA[i] = 0x30
		}
		if x.SigVerifyCostSecp256K1 != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MaxTxGas", wireType)
				}
				x.MaxTxGas = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxTxGas |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 7:
				...
				x.TxFees = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *Params) GetMaxTxGas() uint64 {
	if x != nil {
		return x.MaxTxGas
	}
	return 0
...
func (x *Params) GetTxFees() string {
	if x != nil {
		return x.TxFees
	}
	return ""
...
var file_cosmos_auth_v1beta1_auth_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x84, 0x01, 0x0a, 0x10, 0x4d, 0x6f, 0x64, 0x75,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x8e,
	...
	,
	...
	0x32, 0x35, 0x36, 0x6b, 0x31, 0x12, 0x1c, 0x0a, 0x0a, 0x6d, 0x61, 0x78, 0x5f, 0x74, 0x78, 0x5f,
	0x67, 0x61, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x6d, 0x61, 0x78, 0x54, 0x78,
	0x47, 0x61, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x66, 0x65, 0x65, 0x73, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x78, 0x46, 0x65, 0x65, 0x73, 0x3a, 0x21, 0xe8, 0xa0,
	...
	0xc4, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x09, 0x41, 0x75, 0x74,
	0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x30, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
