...
func TestSimulateMsgSubmitProposal(t *testing.T) {
	...
	require.Equal(t, "107242728498552699278pol", msg.InitialDeposit[0].String())
...
func TestSimulateMsgSubmitLegacyProposal(t *testing.T) {
	...
	require.NotEqual(t, len(msg.InitialDeposit), 0)
	require.Equal(t, "475631230611250741680pol", msg.InitialDeposit[0].String())
...
func TestSimulateMsgDeposit(t *testing.T) {
	...
	require.Equal(t, "98100858108421259236pol", msg.Amount[0].String())
...
func TestSimulateMsgVoteWeighted(t *testing.T) {
	...
	proposal, err := v1.NewProposal([]sdk.Msg{contentMsg}, 1, submitTime, submitTime.Add(*depositPeriod), "", "text proposal", "test", proposer, false)
	require.NoError(t, err)
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, uint64(1), msg.ProposalId)
	require.Equal(t, "0xb316fa9fa91700d7084d377bfdc81eb9f232f5ff", msg.Voter)
